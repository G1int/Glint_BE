...
public class UserDetailController {
    ...
    public ResponseEntity<UserDetailResponse> createUserDetail(@PathVariable Long userId, @Valid @RequestBody UserDetailRequest userDetailRequest) {
    ...
    public ResponseEntity<UserDetailResponse> userNickNameValidat(@PathVariable Long userId, @RequestBody UserNickNameRequest userNickNameRequest) {
    ...
    public ResponseEntity<UserDetailResponse> updateUserDetail(@PathVariable Long userId, @Valid @RequestBody UserDetailRequest userDetailRequest) {
