...
values (1, 'test@kakao.com', '2021-07-01 00:00:00', '2021-07-01 00:00:00', 0, 'test', 'KAKAO', 'USER'),
       (2, 'test2@kakao.com', '2021-07-01 00:00:00', '2021-07-01 00:00:00', 0, 'test2', 'KAKAO', 'USER'),
       (3, 'test3@kakao.com', '2021-07-01 00:00:00', '2021-07-01 00:00:00', 0, 'test3', 'KAKAO', 'USER'),
       (4, 'test4@kakao.com', '2021-07-01 00:00:00', '2021-07-01 00:00:00', 0, 'test4', 'KAKAO', 'USER')
;

insert into `user_detail` (id, created_date, modified_date, birthdate, gender, height, nickname, profile_image, user_id)
values (1, '2021-07-01 00:00:00', '2021-07-01 00:00:00', '2000-01-01', 'MALE', '180', 'test', 'test.jpg', 1),
       ...
       (4, '2021-07-01 00:00:00', '2021-07-01 00:00:00', '2002-01-01', 'MALE', '170', 'test4', 'test4.jpg', 4)
;
...
values (1, '2021-07-01 00:00:00', '2021-07-01 00:00:00', '비흡연'),
       (2, '2021-07-01 00:00:00', '2021-07-01 00:00:00', '흡연')
;
...
values (1, '2021-07-01 00:00:00', '2021-07-01 00:00:00', '삼성전자', null);
...
values (1, '2021-07-01 00:00:00', '2021-07-01 00:00:00', '안녕하세요 자기소개입니다.', 1, 1, 1, 1, 1, 1, 1),
       (2, '2021-07-01 00:00:00', '2021-07-01 00:00:00', '안녕하세요 두번째 자기소개입니다..', 2, 1, 1, 1, 1, 1, 1),
       (3, '2021-07-01 00:00:00', '2021-07-01 00:00:00', '안녕하세요 세번째 자기소개입니다..', 3, 1, 1, 1, 2, 1, 1),
       (4, '2021-07-01 00:00:00', '2021-07-01 00:00:00', '안녕하세요 네번째 자기소개입니다..', 4, 1, 1, 1, 2, 1, 1)
;
...
values (1, 'AGE', null)
     ...
     , (1, null, 'HEIGHT')
;
insert into meeting_smoking_ids (meeting_meeting_id, man_smoking_id, woman_smoking_id)
values (1,1,1);

insert into join_meeting (create_at, created_date, join_date_time, join_meeting_id, meeting_id, modified_date, user_id, status)
values
    ('2021-07-01 00:00:00',null,'2021-07-01 00:00:00',1,1,'2021-07-01 00:00:00',1,'ACCEPTED'),
    ('2021-07-01 00:00:00',null,'2021-07-01 00:00:00',2,1,'2021-07-01 00:00:00',3,'WAITING')
;

INSERT INTO meeting_affiliation (meeting_meeting_id, woman_affiliation, man_affiliation) VALUES (1, null, '삼성전자');
INSERT INTO meeting_affiliation (meeting_meeting_id, woman_affiliation, man_affiliation) VALUES (1, null, '서울대학교');
INSERT INTO meeting_affiliation (meeting_meeting_id, woman_affiliation, man_affiliation) VALUES (1, '서울대학교', null);




insert into chat_room (id, meeting_id, name, is_activated, is_archived) values (1, 1, 'chatRoom1', true, false);
insert into chat_room_user_ids (chat_room_id, user_id) values (1, 1);
insert into chat_room_user_ids (chat_room_id, user_id) values (1, 2);
insert into chat_room_user_ids (chat_room_id, user_id) values (1, 3);
insert into chat_room_user_ids (chat_room_id, user_id) values (1, 4);


insert into chat(id, message, send_user_id, chat_room_id, send_date) values (1, '안녕하세요', 1, 1, '2024-01-01 00:00:00');
insert into chat(id, message, send_user_id, chat_room_id, send_date) values (2, '안녕하세요2', 1, 1, '2024-01-01 01:00:00');